...
use data_components::milvus::ComputeQueryVector;
use llms::embeddings::Embed;
use snafu::ResultExt;
use std::sync::Arc;

/// Embeds the query string at scan time using the embedding model bound to the
/// Milvus index (the same model the collection's vectors were produced with).
#[derive(Debug)]
